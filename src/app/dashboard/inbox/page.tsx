        ...
        >
          {[
            ...
            >
              {label}
              <span
                className={`badge ${tab === key ? "badge-amber" : ""}`}
            ...
            {activeList.map((q) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <Link
                      href={`/vehicles/${typeof v === "object" ? v._id : v}`}
                      style={{
                        display: "flex",
                        alignItems: "center",
                        gap: 6,
                      ...
                      {replyOpen[q._id] ? (
                        <div style={{ display: "flex", gap: 8 }}>
                          <input
                            ...
                            onKeyDown={(e) =>
                              e.key === "Enter" && handleAnswer(q._id)
                            }
                          />
                          <button
